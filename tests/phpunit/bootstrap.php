...
// Make CRM_Notification_ExtensionUtil available.
require_once __DIR__ . '/../../notification.civix.php';

// phpcs:disable PSR1.Files.SideEffects

// Add test classes to class loader.
addExtensionDirToClassLoader(__DIR__);
addExtensionToClassLoader('notification');
 ...
 */
function _notification_test_civicrm_container(ContainerBuilder $container): void {
}
